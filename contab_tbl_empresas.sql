...
CREATE TABLE `tbl_empresas` (
  ...
  `cnpj_empresa` varchar(13) DEFAULT NULL,
  `seq_empresa` int(11) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `tbl_empresas` VALUES (1,'cucau','123456789202',1),(1,'estaleiro','123456789202',2),(1,'santa helena','123456789202',3),(1,'santa maria','34343432',4);
